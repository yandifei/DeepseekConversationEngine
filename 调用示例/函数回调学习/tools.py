...
tool1 = {  # 列表中的第一个 (也是唯一的) 工具定义。
    "type": "function",  # 指定工具类型为 'function' (函数)。
    "function": {  # 函数的详细定义。
        "name": "get_current_time_and_calendar_info",  # 函数的名称。
        "description": "获取现在的年份, 月份, 日期, 小时, 分钟, 秒钟, 毫秒, 星期几, 星期, 秒级时间戳, 毫秒级时间戳, 公历日期, 农历日期, 农历年, 农历月, 农历日, 生肖, 天干地支, 是否为节假日, 节日名称, 是否为国际性节日, 二十四节气",  # 函数的描述，告诉模型何时使用此函数。
    },
}



def get_current_time_and_calendar_info():
    """
...
# print(get_current_time_and_calendar_info())



tool2 = {  # 列表中的第一个 (也是唯一的) 工具定义。
    "type": "function",  # 指定工具类型为 'function' (函数)。
    "function": {  # 函数的详细定义。
        "name": "get_current_time_and_calendar_info",  # 函数的名称。
        "description": "获取当前的具体时间、日期、日历信息及节日",  # 函数的描述，告诉模型何时使用此函数。
