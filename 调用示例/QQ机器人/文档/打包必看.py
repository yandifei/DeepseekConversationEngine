...
pyinstaller --hidden-import comtypes --add-data "A:/Anaconda3/envs/QQBot/Lib/site-packages/comtypes;comtypes" --add-data "A:/Anaconda3/envs/QQBot/Lib/site-packages/uiautomation/bin;uiautomation/bin" -i .\文档\QQ_chat_AI.ico --splash .\文档\QQ_chat_AI.png --uac-admin -D QQ聊天AI.py
